    ...
    return(
        <S.Main>
            ...
            <S.SectionRedesSociais>
                ...
                <S.Pinfo>Ola sou João Pedro, desenvlvedor Front-end, formado pela instituição vai na Web, tenho 26 anos, e cai de paraquedas no mundo da tecnologia, onde me reencontrei profissionalmente e pesoalmente.</S.Pinfo>
            </S.SectionRedesSociais>
        </S.Main>
    );
